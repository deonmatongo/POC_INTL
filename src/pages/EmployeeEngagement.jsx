...
function EmployeeEngagementContent() {
  const { t } = useLanguage();
  
  useEffect(() => {
    document.title = t('pages.employeeEngagement.title');
    const metaDescription = document.querySelector('meta[name="description"]') || document.createElement('meta');
    metaDescription.name = 'description';
    metaDescription.content = t('pages.employeeEngagement.metaDescription');
  ...
  return (
    ...
    <main>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-20">
        ...
        >
          {t('pages.employeeEngagement.heroTitle')}
        </motion.h1>
      </div>
    </section>
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
            {t('pages.employeeEngagement.content1')}
          </p>
        </motion.div>
        </div>
      </section>
