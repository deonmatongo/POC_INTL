...
function LeadershipDevelopmentContent() {
  const { t } = useLanguage();
  
  useEffect(() => {
    document.title = t('pages.leadershipDevelopment.title');
    const metaDescription = document.querySelector('meta[name="description"]') || document.createElement('meta');
    metaDescription.name = 'description';
    metaDescription.content = t('pages.leadershipDevelopment.metaDescription');
  ...
  return (
    ...
    <main>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-20">
        ...
        >
          {t('pages.leadershipDevelopment.heroTitle')}
        </motion.h1>
      </div>
    </section>
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
            {t('pages.leadershipDevelopment.content1')}
          </p>
          
          <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
            {t('pages.leadershipDevelopment.content2')}
          </p>
          
          <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
            {t('pages.leadershipDevelopment.content3')}
          </p>
        </motion.div>
        </div>
      </section>
