...
function LeadThroughChangeContent() {
  ...
  const services = [
    { icon: TrendingUp, title: t('pages.leadThroughChange.service1') },
    { icon: Users, title: t('pages.leadThroughChange.service2') },
    { icon: Target, title: t('pages.leadThroughChange.service3') },
    { icon: Zap, title: t('pages.leadThroughChange.service4') },
  ];
  ...
  return (
    ...
    <main>
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden pt-24" aria-label="Lead Through Change Hero">
        <div 
        ...
        >
          ...
          <div className="mt-16">
            <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 mb-12 text-center">
              {t('pages.leadThroughChange.servicesTitle')}
            </h2>
